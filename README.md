...
🧠 Smart data handling for better insights
...
**Backend: Python using flask as a framework**
...
5. **Access the application through the browser or console**
...
🤖 AI-based stock prediction and alerts
